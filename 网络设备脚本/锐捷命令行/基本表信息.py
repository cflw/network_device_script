...
class F接口表(数据表.I解析表格管线):
	...
	c速率 = 67
	c类型 = 77	#铜还是光纤
	ca列 = 序列.C切片组(c接口, c状态, c虚拟局域网, c双工, c速率, c类型)
	c标题行0 = "Interface                                Status    Vlan   Duplex   Speed     Type  "
	c标题行1 = "---------------------------------------- --------  ----   -------  --------- ------"
	def __init__(self):
		数据表.I解析表格管线.__init__(self)
		self.f添加字段(数据表.E字段.e本端接口, F接口表.ca列.F切片(0), 思科接口.f创建接口)
		self.f添加字段(数据表.E字段.e本端链路状态, F接口表.ca列.F切片(1), 信息.f解析起宕状态)
		self.f添加字段(数据表.E字段.e本端虚拟局域网, F接口表.ca列.F切片(2), int)
		self.f添加字段(数据表.E字段.e本端双工模式, F接口表.ca列.F切片(3), f解析双工)
		self.f添加字段(数据表.E字段.e本端速率, F接口表.ca列.F切片(4), f解析速率)
...
class F交换接口表(数据表.I解析表格管线):
	...
	c虚拟局域网 = 78	#意义不明的列
	c列表 = 83	#意义不明的列
	ca列 = 序列.C切片组(c接口, c交换, c模式, c接入, c本征, c保护, c虚拟局域网, c列表)
	c标题行0 = "Interface                        Switchport Mode      Access Native Protected VLAN lists"
	c标题行1 = "-------------------------------- ---------- --------- ------ ------ --------- ----------------------"
	def __init__(self):
		数据表.I解析表格管线.__init__(self)
		self.f添加字段(数据表.E字段.e本端接口, F交换接口表.ca列.F切片(0), 思科接口.f创建接口)
		self.f添加字段(数据表.E字段.e本端链路类型, F交换接口表.ca列.F切片(2), 信息.f解析链路类型)
...
class F物理地址表(数据表.I解析表格管线):
	...
	c接口 = 42
	c时间 = 73
	ca列 = 序列.C切片组(c虚拟局域网, c物理地址, c类型, c接口, c时间)
	...
	def __init__(self):
		...
		self.f添加字段(数据表.E字段.e本端接口, F物理地址表.ca列.F切片(3), 思科接口.f创建接口)
	f初始处理 = staticmethod(数据表.F去标题行(c标题行0, c标题行1))
	fi有效行 = staticmethod(数据表.F有效行长度(90))
f物理地址表 = F物理地址表()
#===============================================================================
# 地址解析表
#===============================================================================
