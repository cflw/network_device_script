...
class C接口表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v接口s, 实现接口.ca接口缩写, ai字典字符串在右 = False)
			v状态 = "up" in v状态s
...
class C网络接口表4:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v接口s, 实现接口.ca接口名称)
...
class C物理地址表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v端口s, 实现接口.ca接口缩写, ai字典字符串在右 = False)
...
class C地址解析表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v接口1, 实现接口.ca接口缩写, ai字典字符串在右 = False)
			v寿命 = int(v寿命s) * 60
