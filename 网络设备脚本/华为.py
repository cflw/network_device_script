...
class E型号(enum.IntEnum):
	...
	c无线控制器 = 0x00100000
	c无线接入点 = 0x00200000
	c引擎 = 0x01000000	#适用于: ne系列路由器, cx系列路由器, ce系列交换机
	#交换机
	s3700 = c交换机 + 0x3700
	s3928 = c交换机 + 0x3928
	s5700 = c交换机 + 0x5700
	s7700 = c交换机 + 0x7700
	ce6800 = c交换机 + c引擎 + 0x6800	#ce = cloud engine
	ce12800 = c交换机 + c引擎 + 0x12800
	#路由器
	ar201 = c路由器 + 0x0201
	ar1220 = c路由器 + 0x1220
	ar2220 = c路由器 + 0x2220
	ar2240 = c路由器 + 0x2240
	ar3260 = c路由器 + 0x3260
	ne40e = c路由器 + c引擎 + 0x4000	#ne = network engine
	ne5000e = c路由器 + c引擎 + 0x5000
	ne9000 = c路由器 + c引擎 + 0x9000
	#无线控制器
	ac6005 = c无线控制器 + 6005
	ac6605 = c无线控制器 + 6605
	#无线接入点
