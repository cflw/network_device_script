...
ca版本字符串 = {
	...
	"ipv6": 协议.E协议.e网络协议6,
	"rip": 协议.E协议.e路由信息协议,
	"ripng": 协议.E协议.e下一代路由信息协议,
	"ospf": 协议.E协议.e开放最短路径优先,
	"ospfv2": 协议.E协议.e开放最短路径优先2,
	"ospfv3": 协议.E协议.e开放最短路径优先3,
	"eigrp": 协议.E协议.e增强内部网关路由协议,
	"isis": 协议.E协议.e中间系统到中间系统,
	"bgp": 协议.E协议.e边界网关协议
}
ca版本整数_网络协议 = {
	4: 协议.E协议.e网络协议4,
...
ca版本转换_网络协议到开放最短路径优先 = {
	协议.E协议.e网络协议4: 协议.E协议.e开放最短路径优先,
	协议.E协议.e网络协议6: 协议.E协议.e开放最短路径优先3
}
ca版本转换_增强内部网关路由协议到网络协议 = {
	协议.E协议.e增强内部网关路由协议: 协议.E协议.e网络协议4
}
def f解析版本(a, aa版本整数字典):	#返回协议
	"返回 E协议 值"
	if isinstance(a, 协议.E协议):
		return a
	v类型 = type(a)
	if v类型 == int:
		return aa版本整数字典[a]
