...
class F接口表_sv3(数据表.I解析表格管线):
	...
	def __init__(self):
		...
		self.f添加字段(数据表.E字段.e本端接口, F接口表_sv3.ca列[0], 实现接口.f创建接口缩写_sv3),
		self.f添加字段(数据表.E字段.e本端管理状态, F接口表_sv3.ca列[1], 信息.f解析起宕状态),
		self.f添加字段(数据表.E字段.e本端链路状态, F接口表_sv3.ca列[2], 信息.f解析起宕状态),
		self.f添加字段(数据表.E字段.e本端描述, F接口表_sv3.ca列[8], 运算.f原值)
