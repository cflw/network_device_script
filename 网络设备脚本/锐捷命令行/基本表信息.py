...
class C接口表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			yield 信息.S接口表项(a接口 = v接口, a状态 = v状态, a速率 = v速率, a双工 = v双工, a虚拟局域网 = v虚拟局域网)
class C交换接口表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 思科接口.f创建接口(v接口s)
			v虚拟局域网 = int(v接入s)
			yield 信息.S接口表项(a接口 = v接口, a虚拟局域网 = v虚拟局域网)
#===============================================================================
# 网络接口表
#===============================================================================
class C网络接口表4:
...
class C物理地址表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			yield 信息.S物理地址表项(a地址 = v物理地址, a接口 = v接口, a虚拟局域网 = v虚拟局域网, a类型 = v类型)
#===============================================================================
# 地址解析表
#===============================================================================
class C地址解析表4:
