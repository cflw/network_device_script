...
class I列表显示_v5(I列表显示):
	def fg显示命令(self, a序号 = None):
		...
		return v命令
class C基本4显示_v5(I列表显示_v5, C基本4显示):
	c类型 = c基本
	c协议 = c网络协议4
class C高级4显示_v5(I列表显示_v5, C高级4显示):
	c类型 = c高级
	c协议 = c网络协议4
class C基本6显示_v5(I列表显示_v5, C基本6显示):
	c类型 = c基本
	c协议 = c网络协议6
class C高级6显示_v5(I列表显示_v5, C高级6显示):
	c类型 = c高级
	c协议 = c网络协议6
#===============================================================================
# 配置
...
class I列表配置_v5(I列表配置):
	...
	def fg进入命令(self):
		...
		v命令 += f生成名称_v5(self.m名称)
		return v命令
class C基本4配置_v5(I列表配置_v5, I列表显示_v5, C基本4配置, C基本4显示):
	c类型 = c基本
	c协议 = c网络协议4
class C高级4配置_v5(I列表配置_v5, I列表显示_v5, C高级4配置, C高级4显示):
	c类型 = c高级
	c协议 = c网络协议4
class C基本6配置_v5(I列表配置_v5, I列表显示_v5, C基本6配置, C基本6显示):
	c类型 = c基本
	c协议 = c网络协议6
class C高级6配置_v5(I列表配置_v5, I列表显示_v5, C高级6配置, C高级6显示):
	c类型 = c高级
	c协议 = c网络协议6
#===============================================================================
# 其它
