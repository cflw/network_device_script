...
class I访问控制列表_v5(I访问控制列表):
	...
	def fg显示命令(self, a序号 = None):
		...
		return v命令
class C基本4_v5(I访问控制列表_v5, C基本4):
	def __init__(self, a, a名称):
		I访问控制列表_v5.__init__(self, a, a名称, c基本, c网络协议4)
class C高级4_v5(I访问控制列表_v5, C高级4):
	def __init__(self, a, a名称):
		I访问控制列表_v5.__init__(self, a, a名称, c高级, c网络协议4)
class C基本6_v5(I访问控制列表_v5, C基本6):
	def __init__(self, a, a名称):
		I访问控制列表_v5.__init__(self, a, a名称, c基本, c网络协议6)
class C高级6_v5(I访问控制列表_v5, C高级6):
	def __init__(self, a, a名称):
		I访问控制列表_v5.__init__(self, a, a名称, c高级, c网络协议6)
#===============================================================================
# 其它
#===============================================================================
class C助手(北向列表.I助手):
