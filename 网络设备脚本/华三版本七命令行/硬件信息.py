...
f简单风扇信息_v7 = F简单信息_v7(数据表.E字段.e本端风扇状态)
f简单电源信息_v7 = F简单信息_v7(数据表.E字段.e本端电源状态)
#===============================================================================
# 风扇
#===============================================================================
ca风扇方向 = {
...
f电源信息_v7 = F电源信息_v7()
class F电源机架_s9v7(数据表.I解析表格管线):
	"""display power 的其中一个机架
	适用于: 华三s9810(v7.1.*)"""
	c标识 = 0
	c状态 = 9
	c电流 = 24
	c电压 = 36
	c功率 = 48
	ca列 = 数据表.C切割列(c标识, c状态, c电流, c电压, c功率)
	c标题行0 = " PowerID State          Current(A)  Voltage(V)  Power(W)"
	c数据行0 = " 2       Normal           3.03       56.37      170.80"
	def __init__(self):
		数据表.I解析表格管线.__init__(self)
		self.f添加字段(数据表.E字段.e本端索引, self.ca列[0], int)
		self.f添加字段(数据表.E字段.e本端电源状态, self.ca列[1], lambda x: "Normal" in x)
		self.f添加字段(数据表.E字段.e本端电源电流, self.ca列[2], 信息.f解析数字)
		self.f添加字段(数据表.E字段.e本端电源电压, self.ca列[3], 信息.f解析数字)
		self.f添加字段(数据表.E字段.e本端输出功率, self.ca列[4], 信息.f解析数字)
	f初始处理 = staticmethod(数据表.F去标题行(c标题行0))
	fi结束 = staticmethod(数据表.fi空行)
#===============================================================================
# 温度
#===============================================================================
class F温度信息_v7(数据表.I解析表格管线):
	"""display enviroment
	适用于: 华三s6900(v7.1.070)"""
	c槽位 = 0
	c传感器 = 7
