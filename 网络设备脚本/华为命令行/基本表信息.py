...
class F地址解析表(数据表.I解析多行表格管线):
	...
	def __init__(self):
		...
		self.m行1.f添加字段(数据表.E字段.e本端虚拟局域网, F地址解析表.ca列[3], int)
...
class F物理地址表(数据表.I解析表格管线):
	...
	def __init__(self):
		数据表.I解析表格管线.__init__(self)
		self.f添加字段(数据表.E字段.e对端物理地址, F物理地址表.ca列[0], 地址.S物理地址.fc字符串)
		self.f添加字段(数据表.E字段.e本端虚拟局域网, F物理地址表.ca列[1], lambda x: int(x[:x.find("/")]))
		self.f添加字段(数据表.E字段.e本端接口, F物理地址表.ca列[2], 实现接口.f创建接口缩写)
		self.f添加字段(数据表.E字段.e对端物理地址类型, F物理地址表.ca列[3], 信息.ca物理地址类型.get)
