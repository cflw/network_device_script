...
class C接口表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v接口s, 接口.ca接口缩写, ai字典字符串在右 = False)
			v状态 = "up" in v状态s
			yield 北向接口.S接口表项(a接口 = v接口, a状态 = v状态, a描述 = v描述s)
#===============================================================================
# 网络接口表
#===============================================================================
class C网络接口表4:
...
class C物理地址表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v端口s, 接口.ca接口缩写, ai字典字符串在右 = False)
...
class C地址解析表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v接口 = 北向接口.S接口.fc字符串(v接口1, 接口.ca接口缩写, ai字典字符串在右 = False)
			v寿命 = int(v寿命s) * 60
			yield 信息.S地址解析表项(a网络地址 = v网络地址, a物理地址 = v物理地址, a接口 = v接口, a寿命 = v寿命)